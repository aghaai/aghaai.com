    ...
    >
      <div className="mx-auto max-w-7xl grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-6 gap-4 xs:gap-6 sm:gap-8 lg:gap-10">
        ...
        <div className="xs:col-span-2 sm:col-span-2 lg:col-span-3 mb-4 xs:mb-6 sm:mb-0">
          <Link href={logoHref} className="w-[90px] xs:w-[100px] sm:w-[110px] md:w-[130px] h-[40px] xs:h-[45px] sm:h-[50px] md:h-[60px] flex items-center mb-3 xs:mb-4">
            <Image
              width={130}
              height={130}
              alt="Logo"
        ...
        <div className="mb-4 xs:mb-6 sm:mb-0 lg:col-span-1">
          ...
          <ul className="space-y-1 xs:space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-white/85">
            <li><Link href="https://www.instagram.com/aghaai.css/" className="hover:text-white transition-colors block py-0.5">Instagram</Link></li>
            <li><Link href="https://www.facebook.com/p/Aghaai-61576107164419/" className="hover:text-white transition-colors block py-0.5">Facebook</Link></li>
            <li><Link href="https://www.linkedin.com/company/aghaai/" className="hover:text-white transition-colors block py-0.5">LinkedIn</Link></li>
